...
def is_valid_move(self, src_x, src_y, dest_x, dest_y):
    ...
    if piece.lower() == 'p':  # Pawn
        return self.is_valid_pawn_move(src_x, src_y, dest_x, dest_y)
    elif piece.lower() == 'r':  # Rook
        return self.is_valid_rook_move(src_x, src_y, dest_x, dest_y)
    elif piece.lower() == 'n':  # Knight
        return self.is_valid_knight_move(src_x, src_y, dest_x, dest_y)
    elif piece.lower() == 'b':  # Bishop
        return self.is_valid_bishop_move(src_x, src_y, dest_x, dest_y)
    elif piece.lower() == 'q':  # Queen
        return self.is_valid_queen_move(src_x, src_y, dest_x, dest_y)
    elif piece.lower() == 'k':  # King
        return self.is_valid_king_move(src_x, src_y, dest_x, dest_y)
    else:
