...
# in the folder in order to rename them as 'new_astora.xxx' where 'x' represents
# the png order.

import os, shutil

folder_path = r"C:\Users\94M0\Downloads\astorabrandidentity\astora_brand\assets\assets_nobg"
new_template = "new_astora.{}.png"
...
for index, old_name in enumerate(png_files, start=1):
    new_name = new_template.format(index).replace("removebg-preview", "nobg")
